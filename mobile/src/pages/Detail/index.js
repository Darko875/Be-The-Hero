...
export default function Detail() {
    ...
    const message = 'Olá ' + incident.name + ', estou a entrar em contacto para poder ajudar no caso '+ incident.title + ' com o valor de ' + Intl.NumberFormat('pt-PT', {style: 'currency', currency: 'EUR'}).format(incident.value)
